...
public class AmqpClient implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        System.out.println("启动AmqpClient");
        start();
    }

    private final static Logger logger = LoggerFactory.getLogger(AmqpClient.class);
    private static String accessKey = "LTAI5tLBaeWCdsu9ZWuhYdXh";
    private static String accessSecret = "FvXqDAcd9eeM6btQqmPwOAjS9scd62";
    private static String consumerGroupId = "eizw4Vmxr12ZVwnqTTIi000100";
    ...
    private static String clientId = "kunbo";

    //${YourHost}为接入域名，请参见AMQP客户端接入说明文档。
    private static String host = "1792217328509866.iot-amqp.cn-shanghai.aliyuncs.com";
